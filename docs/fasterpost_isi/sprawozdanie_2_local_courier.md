...
![Panel Kontrolny Logistyki](./screenshots/13_isi_logistic_control_warsaw.png)

Po zatwierdzeniu paczek, kurier widzi podsumowanie operacyjne trasy:

![Panel Kontrolny kuriera](./screenshots/13_isi_localcourier_panel.png)

Odbieranie paczek z magazynu:

![Panel Kontrolny kuriera](./screenshots/13_isi_localcourier_take_packages.png)

Wkładanie paczek do paczkomatu:

![Panel Kontrolny kuriera](./screenshots/13_isi_localcourier_put_packages.png)

Finał trasy:
![Panel Kontrolny kuriera](./screenshots/13_isi_localcourier_final.png)
