...
Na podstawie analizy potrzeb użytkowników zdefiniowano następujące wymagania funkcjonalne systemu, które przedstawiono w Tabeli \ref{tab:wymagania_funkcjonalne}.

\begin{tabularx}{\textwidth}{|l|>{\raggedright\arraybackslash}X|}
\caption{Zestawienie wymagań funkcjonalnych} \label{tab:wymagania_funkcjonalne} \\
\hline
\textbf{Moduł} & \textbf{Wymagania} \\ \hline
\endfirsthead
\hline
\textbf{Moduł} & \textbf{Wymagania} \\ \hline
\endhead
